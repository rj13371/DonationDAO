          ...
          <Box data-aos={isMd ? 'fade-right' : 'fade-up'}>
            <Box marginBottom={2}>
              <Typography variant={'h4'} sx={{ fontWeight: 700 }} gutterBottom>
                Donation DAO is the Web3
                <br /> answer to censorship
              </Typography>
              <Typography variant={'h6'} component={'p'} color="textSecondary">
                <Box component={'span'} fontWeight={400}>
                  With Donation DAO, anyone, anywhere can raise money for any
                  cause that they see fit. We are the answer to Big Tech,
                  governments, and banks attempted control over grassroots
                  fundraising.
                </Box>
              </Typography>
            </Box>
